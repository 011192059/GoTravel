...
<div style="font-size: 20px;margin: 10px;"><b>Login As Admin</b></div>
    ...
    <button id="button" type="button" onclick="register()">Back</button>
</form>
      
<script>
                    function register(){
                        location.assign('register.php');   ///default GET method
                    }
     </script>   
...
<body>
    ...
    <div style="font-size: 20px;margin: 10px;">Login As Admin</div>
        ...
        <br>
        <br>
        <input id="button" type="button" value="Log In" onclick="a_login()">
    </form>
